...
import sessionalSchedulerRouter from "./src/sessional_scheduler/route.js";
import thesisRouter from "./src/thesis/route.js";
...
router.use("/sessional-scheduler", authorize(), sessionalSchedulerRouter);
router.use("/thesis", authorize(), thesisRouter);
